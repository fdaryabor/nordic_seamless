...
LINK_LIBS =-L/usr/local/Cellar/netcdf/4.8.0_1/lib -llapack  -lblas   -lm
...
MPI_INC =  -I/Users/farshidlocal/PDAF/PDAF-D_V1.16/src/dummympi
...
NC_LIB   = -L/usr/local/Cellar/netcdf/4.8.0_1/lib -lnetcdff -lnetcdf
NC_INC   = -I/usr/local/Cellar/netcdf/4.8.0_1/include/
